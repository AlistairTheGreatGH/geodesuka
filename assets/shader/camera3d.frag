...
layout (set = 1, binding = 1) uniform sampler2D SurfaceNormalMap;
layout (set = 1, binding = 2) uniform sampler2D SurfaceHeightMap;
layout (set = 1, binding = 3) uniform sampler2D SurfaceHeightAOC;
layout (set = 1, binding = 4) uniform sampler2D SurfaceRoughness;
layout (set = 1, binding = 5) uniform sampler2D SurfaceMetallic;
